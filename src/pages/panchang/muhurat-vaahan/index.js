...
const MuhuratVaahan = () => {
    ...
    console.log("Panchang Vaahan Data:", panchangVaahan?.description);

    const [inputFieldDetail, setInputFieldDetail] = useState({
        description: panchangVaahan?.description ? RichTextEditor.createValueFromString(panchangVaahan?.description, 'html') : RichTextEditor.createEmptyValue(),
    });
    ...
    useEffect(() => {
        dispatch(PanchangActions.getPanchangVaahan())
    }, []);
    ...
    const handleSubmit = async (e) => {
        ...
        dispatch(PanchangActions.onPanchangVaahan(payload))
