...
const Panchang = () => {
  ...
  console.log("Panchang Data:", panchang?.description);

  const [inputFieldDetail, setInputFieldDetail] = useState({

    description: panchang?.description ? RichTextEditor.createValueFromString(panchang?.description, 'html') : RichTextEditor.createEmptyValue(),
  ...
  useEffect(() => {
    dispatch(PanchangActions.getPanchang())
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    dispatch(PanchangActions.onPanchang(payload))
