...
const MuhuratSampatti = () => {
    ...
    console.log("Panchang Sampatti Data:", panchangSampatti?.description);

    const [inputFieldDetail, setInputFieldDetail] = useState({
        description: panchangSampatti?.description ? RichTextEditor.createValueFromString(panchangSampatti?.description, 'html') : RichTextEditor.createEmptyValue(),
    });
    ...
    const handleSubmit = async (e) => {
        ...
        dispatch(PanchangActions.onPanchangSampatti(payload))
