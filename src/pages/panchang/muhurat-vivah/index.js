...
const MuhuratVivah = () => {
    ...
    console.log("Panchang Vivah Data:", panchangVivah?.description);

    const [inputFieldDetail, setInputFieldDetail] = useState({
        description: panchangVivah?.description ? RichTextEditor.createValueFromString(panchangVivah?.description, 'html') : RichTextEditor.createEmptyValue(),
    });
    ...
    useEffect(() => {
        dispatch(PanchangActions.getPanchangVivah())
    }, []);
    ...
    const handleSubmit = async (e) => {
        ...
        dispatch(PanchangActions.onPanchangVivah(payload))
