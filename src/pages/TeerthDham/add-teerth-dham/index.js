...
const AddTeerthDham = () => {
    ...
    const handleValidation = () => {
        let isValid = true;
        const { bannerTitle } = bannerDetail;
        const { file } = image;
    ...
    const handleSubmit = async (e) => {
        ...
        if (handleValidation()) {
            if (stateData) {
                ...
                const payload = {
                    data: formData,
                    onComplete: () => navigate('/teerthDham')
                }

                console.log(payload);
                //! Dispatching API for Updating banner
                dispatch(BannerActions.editTeerthDham(payload))
                ...
                dispatch(BannerActions.uploadAppTeerthDham(payload))
            }
        }
    };
        ...
        <>
            <div style={{ padding: "20px", backgroundColor: "#fff", marginBottom: "20px", boxShadow: '0px 0px 5px lightgrey', borderRadius: "10px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "30px", fontFamily: 'Philosopher', backgroundColor: "#fff" }}>
                    <div style={{ fontSize: "22px", fontWeight: "500", color: "#000" }}>Add Teerth Dham</div>
