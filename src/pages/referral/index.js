...
const Recharge = () => {
    ...
    const astrologerColumns = [
        ...
        { name: "Receiver Referral Amount", selector: (row) => row?.amount },
        { name: "Sender Referral Amount", selector: (row) => row?.percentage + '%' },
    ...
    return (
        <>
            <MainDatatable data={rechargePlanData} columns={astrologerColumns} title={'Referral'} url={'/referral/add-referral'} />
