...
const AddReligiousCategory = ({ mode }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (handleValidation()) {
            ...
            if (stateData) {
                ...
                const payload = {
                    data: formData,
                    onComplete: () => navigate("/religious/category")
                }

                //! Dispatching API for Creating Category
                dispatch(ReligiousActions.updateReligiousCategory(payload))
                ...
                //! Dispatching API for Creating Category
                dispatch(ReligiousActions.createReligiousCategory(payload))
            }
        }
    };
        ...
        <>
            <div style={{ padding: "20px", backgroundColor: "#fff", marginBottom: "20px", boxShadow: '0px 0px 5px lightgrey', borderRadius: "10px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "30px", fontFamily: 'Philosopher', backgroundColor: "#fff" }}>
                    <div style={{ fontSize: "22px", fontWeight: "500", color: Color.black, }}>{mode} Religious Category</div>
                    <div onClick={() => navigate("/religious/category")} style={{ fontWeight: "500", backgroundColor: Color.primary, color: Color.white, padding: "5px 10px", borderRadius: "5px", cursor: "pointer", fontSize: "14px" }}>Display</div>
                </div>
...
export default AddReligiousCategory;