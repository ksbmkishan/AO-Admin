...
function ViewImageModel({ modalOpen, handleModalImageClose, imageSrc, dimensions, handleEdit, inputFieldDetail,canvasRef,handlePointerDown,handlePointerMove,handlePointerUp,zoom,setZoom,edit,handleSave }) {
    return (
